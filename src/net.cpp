...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Threadcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"drewmjohnson.com", "dnsseed.drewmjohnson.com"},
    //{"threadcointools.com", "dnsseed.threadcointools.com"},
    //{"threadcoinpool.org", "dnsseed.threadcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    //{"threadcointools.com", "testnet-seed.threadcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Threadcoin is probably already running."), addrBind.ToString().c_str());
        else
